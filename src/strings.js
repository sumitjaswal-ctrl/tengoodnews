...
export const STR = {
  en: {
    ...
    slideshow: 'Slideshow', night: 'Night mode', day: 'Day mode', otherLang: 'हिन्दी', otherLangHref: 'hi/', surpriseMe: 'Surprise me',
    ...
    footHome: 'Home', archive: 'Archive of every day', rss: 'RSS feed', follow: 'Follow us: ',
  ...
  hi: {
    ...
    slideshow: 'स्लाइड शो', night: 'रात मोड', day: 'दिन मोड', otherLang: 'English', otherLangHref: './', surpriseMe: 'कुछ नया दिखाओ',
    ...
    footHome: 'होम', archive: 'हर दिन का संग्रह', rss: 'RSS फ़ीड', follow: 'हमें फ़ॉलो करें: ',
